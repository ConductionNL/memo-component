# memo-component chart

The Helm chart installs memo-component and by default the following dependencies using subcharts:
...
```bash
helm repo add memo-component https://raw.githubusercontent.com/ConductionNL/memo-component/master/api/helm/
helm repo update
```
...
```bash
helm install my-memo-component ConductionNL/memo-component --version 0.1.0
```
...
| `settings.subdomain` | the subdomain of the installation excluding www. | `memo-component` |
| `settings.subpath` | Any sub path to follow the domain, like /api/v1 | `memo-component` |
